                ...
                <form>
                    <div class="md:flex items-center mt-12">
                        ...
                        <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                            ...
                            <input type="email" class="leading-none text-gray-50 p-3 focus:outline-none focus:ring  focus:border-blue-700 mt-4 border-0 bg-gray-800 rounded" />
                        </div>

                        <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label class="font-semibold leading-none text-gray-300">Phone Number</label>
                            <input type="number" class="leading-none text-gray-50 p-3 focus:outline-none focus:ring  focus:border-blue-700 mt-4 border-0 bg-gray-800 rounded" />
                        </div>
                    </div>

                    <div class="w-full flex flex-col mt-8">
                        <label class="font-semibold leading-none text-gray-300">About Your Self?</label>
                        <textarea type="text" class="h-40 text-base leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-800 border-0 rounded focus:ring"></textarea>
                        </div>
